    ...
    <div class="flex-container">
        ...
        <div class="flex-main" style="min-height: 130vh;">
            <form method="post">
                ...
                <p style="opacity: 0.8; text-align:center; background-color: #333b; color: white; margin: 0em; border-radius: 0em 0em 2em 2em; padding: 0em;">Online banking</p>
                <div class="container" style="text-align:center;">
                    ...
                    <p class="row">
                        <p class="col-50"></p>
                        <p class="col-50"><?php echo '<button><a href="reservation2.php?roomid='.$roomID.'">Change to DUITNOW QR</a></button>'; ?></p>
                    </p>
                    <p class="row">
            ...
            <?php
                if (isset($_POST['submit'])) {
                    ...
                    if (mysqli_num_rows($resultReservation) > 0) {
                        ...
                        $sql = "INSERT INTO reservation (customer_id, room_id, reservation_date, reservation_date_in, reservation_date_out, reservation_status, payment_type, account_number, total_payment) VALUES ('$customerID', '$roomSelection', '$date', '$datein', '$dateout', '$defaultStatus', 'Online Transfer', '$_POST[accountnumber]', '$_POST[totalpayment]')";
