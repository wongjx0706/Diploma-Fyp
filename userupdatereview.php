<?php
    ...
    $sql5 = "SELECT * FROM review WHERE review_id = $reviewid";
    $result5 = mysqli_query($conn, $sql5);
    $row = mysqli_fetch_assoc($result5);
    $userreview = $row['review_description'];
        ...
        <div class="container">
            <form method="post">
                ...
                <p class="row">
                    ...
                    <p class="col-50">Your Past Review :<br/><?php echo $userreview ?></p>
                    <p class="col-50">Enter your review :<br><textarea name="reviewdescription" rows="4" cols="50" required placeholder="ENTER YOUR REVIEW UPDATE" autocomplete="off"></textarea></p>
                </p>
                <input type="submit" name="submit" value="Submit">
                <button class="back"><a href="userviewreview.php"><i class="fa-sharp fa-solid fa-backward"></i> Back</a></button>
            </form>
        </div>
            ...
            <?php
                if(isset($_POST['submit'])){
                    ...
                    $sql4 = "UPDATE review SET review_description = '$reviewdescription' WHERE review_id = $reviewid";
