...
include 'navbar.php';
  ...
  $select = " SELECT * FROM staff WHERE staff_email = '$email' && staff_password = '$pass' ";
...
<div class="container">
  <form action="" method="post">
    <h1 class="header" style="text-align: center; margin-bottom: 1em; color: #fff;">STAFF LOGIN</h1>
